...
public class BookManager {
	...
	public static class BookRecord implements Serializable, Comparable<BookRecord> {
		 ...
		 * 
		 * 1 - Book Name 2 - Book Author 3 - Year Published 4 - ISBN 5 - Cover
		 * Price
		 */
		...
		public boolean equals(Object o) {
			...
			return this.name.equals(b.name) && this.author.equals(b.author) && this.type.equals(b.type) && this.yearPublished.equals(b.yearPublished) && this.isbn.equals(b.isbn) && this.coverPrice == b.coverPrice;
		}

		/*
		 * Overriding the compareTo method, used during sorting
		 */
		@Override
	 ...
	 * FILE OPEATIONS
	 * 
	 * Serialization and de-serialization of the data to a file. Ensures file
	 * integrity and also prevents user from directly accessing the file.
	 */
	...
	/*
	 * Part of the fuzzy-matching algorithm, ignores cases and also spaces in
	 * search query
	 */
	...
	/*
	 * Edit Distance Dynamic Programming algorithm to perform FUZZY-MATCHING of
	 * the names, and authors.
	 * 
	 * Calculates the operations (add, remove, edit) to transform String t1 into
	 * t2, to calculate similarity.
	 * 
	 * Two strings are considered the same if the edit distance is less than 5.
	 */
	...
	public static class MainGUI extends JFrame {
		...
		public MainGUI() {
			...
			/*
			 * Create Book button: Creates new empty record in database, open a
			 * information editor to edit the record
			 */
			...
			/*
			 * Search by Author: See "Search by Name"
			 */
			...
			/*
			 * Search by ISBN: Same as "Search by Name", except exact match
			 */
			 ...
			 * class (see class def), and uses quick sort to sort the records
			 */
			...
			/*
			 * About button: Opens a pop-up with credit information
			 */
			...
			/*
			 * Quit button: Safely quit the program by saving DB into file and
			 * exiting.
			 * 
			 * This EXACT code is also overloaded to the windowClosing event, so
			 * either is fine.
			 */
